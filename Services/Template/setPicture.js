var TeamsID = require('TeamsID');

// Retry settings for asynchronous call
const NUMBER_OF_RETRIES = 40;
const RETRY_TIME_MSEC = 5 * 1000; // 5 sec

// SetPicture() - Returns a boolean I hope https://docs.microsoft.com/en-us/graph/api/team-update-photo?view=graph-rest-beta
module.exports = function SetPicture(context, token, templateString) {
